...
final class MainHomeVC: UIViewController {
    ...
    private func configureUI() {
        ...
        totalAdvertisementsButton.addTarget(self, action: #selector(tapOnTotalAdvertisementsButton), for: .touchUpInside)
    ...
    // MARK: - FUNC FOR TOTAL ADVERTESEMENTS BUTTON:
    
    @objc private func tapOnTotalAdvertisementsButton() {
        let searchViewController = TotalListAdsVC()
